...
import { getClientSitePagePayload } from "@/lib/templates/registry";
    ...
    return (
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-[var(--meridian-space-page)] py-14">
        <EmptyState
          ...
          description="This business has no assigned active Meridian template matching its dashboard mode. Assign one in admin before preview or publish."
        />
      </main>
    );
  }
